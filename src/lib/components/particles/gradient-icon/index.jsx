...
export const GradientIcon = ({ startColor, endColor, styles }) => {
  ...
  return (
    <svg class={styles.svg} width="24" height="11" viewBox="0 0 24 11" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="url(#gv-gradient)"
      />
      <defs>
        <linearGradient id="gv-gradient" x1="5.5" y1="5.5" x2="12" y2="5.5" gradientUnits="userSpaceOnUse">
          <stop class={`${styles.previous}`} stopColor={startColor} />
          <stop class={`${styles.next}`} stopColor={endColor} offset="1" />
        </linearGradient>
      </defs>
    </svg>
  )
